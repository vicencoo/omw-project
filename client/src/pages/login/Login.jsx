...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-green-600 px-4 py-10 relative overflow-hidden">
      {/* Radial glow */}
      ...
      <div className="relative z-10 w-full max-w-110 bg-green-700 border border-[rgba(201,162,39,0.15)] rounded-sm backdrop-blur-sm px-10 py-12 sm:px-8 sm:py-10">
        {/* Logo */}
        <div className="flex flex-col items-center mb-9">
          ...
          <p className="text-[10px] tracking-[3px] uppercase text-white/70 font-light mt-1">
            On My Way
          </p>
        </div>
        ...
        <p className="text-white/80 text-[13px] font-light text-center mb-7">
        ...
        <div className="mb-5">
          <label className="block text-[11px] tracking-[2px] uppercase text-white/75 font-medium mb-2">
            Username
          </label>
          <div className="relative flex items-center">
            <span className="absolute left-3.5 text-[rgba(255,206,44,0.5)] flex items-center pointer-events-none">
            ...
            <input
              ...
              className="w-full bg-white/4 border border-white/10 rounded-sm text-white text-sm font-light pl-10 pr-4 py-3.5 outline-none placeholder:text-white/60 focus:border-[rgba(201,162,39,0.55)] focus:bg-[rgba(201,162,39,0.04)] transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full bg-white/4 border border-white/10 rounded-sm text-white text-sm font-light pl-10 pr-12 py-3.5 outline-none placeholder:text-white/60 focus:border-[rgba(201,162,39,0.55)] focus:bg-[rgba(201,162,39,0.04)] transition-all duration-200"
            />
            <button
              type="button"
