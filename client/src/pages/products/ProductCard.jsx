...
export const ProductCard = ({ product, t }) => {
  return (
    <div
    ...
    >
      <div className='relative overflow-hidden h-55'>
        <img
          src={product.image}
          alt={t(`products.prods.${product.name}`)}
        ...
        {product.badge && (
          ...
          >
            {t(`products.prods.${product.badge}`)}
          </span>
        )}
      </div>
      ...
      <div className='flex flex-col flex-1 p-7'>
        ...
        <Text
          text={t(`products.prods.${product.name}`)}
        ...
        <Text
          text={t(`products.prods.${product.description}`)}
          size='text-sm'
          font='font-light'
