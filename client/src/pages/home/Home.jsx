...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-20 py-20">
        ...
        <section className="container">
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="flex flex-col gap-7 md:border-b-2 md:border-green-200 md:pb-10">
              <div className="flex items-center gap-2">
                ...
                <Text
                  ...
                  className="uppercase text-green-700 tracking-[0.2em] "
                />
              </div>
              <Text
                text={t("heroTitle")}
                ...
                className="text-green-700 leading-snug italic"
              />
            ...
            <div className="flex w-full h-full relative">
              <img
                src="/images/gas-station-home.webp"
      ...
      <Reveal>
        <section className="flex flex-col lg:flex-row w-full md:py-14 py-8 md:px-0 px-10 bg-linear-to-r from-green-600 to-green-700 justify-center">
            ...
            >
              <div className="flex flex-col gap-1 px-22 items-center">
                ...
                <Text
                  ...
                  size="text-xs"
                  font="font-medium"
                  className="uppercase tracking-widest text-white/75"
                />
              </div>
            </Reveal>
          ))}
